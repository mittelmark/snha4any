...
# Test Floats
print(f"Sum: {mglib.sum_float_array([1.1, 2.2, 3.3])}")

# Test Strings
words = mglib.create_string_array()
print(f"From C: {words}")

# Test Bools
print(f"True count: {mglib.count_true_values([True, False, True, True])}")
