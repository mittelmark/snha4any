...
- Alba de Prada, University of Potsdam (graph and data generation modules)
- Christopher Olvera, University of Potsdam (implementation of SNHA algorithm and accuracy metrics)
- Detlef Groth, University of Potsdam (supervisor and random data generation)
- Harsini Praveen Kumar, University of Potsdam (statisics module)
